    ...
    <footer ref={footerRef} className="py-10 pb-16 border-t border-slate-800/90 opacity-100">
      ...
      <div className="w-full px-8 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <div className="flex items-center font-extrabold mb-0">
              <img
                src="/LOGO.avif"
                alt="Logo"
                className="w-[80px] h-auto object-contain -ml-1"
              />
            </div>
            <p className="text-white/62 text-sm leading-relaxed max-w-[30ch]">
            ...
            <div className="flex gap-3 mt-4">
              <a
                ...
                className="text-white/50 hover:text-brand-accent transition-colors duration-300"
          ...
          {/* Company */}
          <div>
            <h4 className="font-mono text-xs uppercase tracking-[0.22em] text-brand-accent/90 mb-4">Company</h4>
            <div className="flex flex-col gap-2">
              <Link href="/about" className="text-white/62 hover:text-white transition-colors duration-300 text-sm no-underline">About Us</Link>
              <Link href="/our-team" className="text-white/62 hover:text-white transition-colors duration-300 text-sm no-underline">Our Team</Link>
              <Link href="/#clients" className="text-white/62 hover:text-white transition-colors duration-300 text-sm no-underline">Clients</Link>
              <Link href="/contact" className="text-white/62 hover:text-white transition-colors duration-300 text-sm no-underline">Contact</Link>
            </div>
          </div>

          {/* Resources */}
          <div>
            <h4 className="font-mono text-xs uppercase tracking-[0.22em] text-brand-accent/90 mb-4">Resources</h4>
            <div className="flex flex-col gap-2">
              <Link href="/services" className="text-white/62 hover:text-white transition-colors duration-300 text-sm no-underline">Services</Link>
              <Link href="/portfolio" className="text-white/62 hover:text-white transition-colors duration-300 text-sm no-underline">Portfolio</Link>
              <Link href="/blog" className="text-white/62 hover:text-white transition-colors duration-300 text-sm no-underline">Blog</Link>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-slate-800/90 flex justify-between items-center max-md:flex-col max-md:gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="font-mono text-xs uppercase tracking-[0.14em] text-white/40 hover:text-white/80 transition-colors duration-300 no-underline">Privacy</a>
          </div>
        </div>
      </div>
    </footer>
